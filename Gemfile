...
# NOTE: ActiveStorage not available in Rails 5.1 — keep paperclip until Rails upgrade
gem 'paperclip', '4.2.4'
...
## CSS
gem 'susy'
gem 'sassc-rails' # replaced sass-rails — compatible with Rails 5.1
gem 'bourbon', '4.3.4'
...
gem 'i18n-js'
# coffee-rails removed — use plain JavaScript or ES modules
gem 'therubyrhino'
gem 'selectivizr-rails'
# uglifier removed — use terser via jsbundling-rails when upgrading asset pipeline
# NOTE: For Rails 5.1 with Sprockets, keeping uglifier may be necessary
# gem 'uglifier'
gem 'modernizr-rails'
...
# delayed_paperclip removed — use ActiveStorage with ActiveJob (requires Rails 5.2+)
# NOTE: Keep until paperclip is migrated to ActiveStorage
